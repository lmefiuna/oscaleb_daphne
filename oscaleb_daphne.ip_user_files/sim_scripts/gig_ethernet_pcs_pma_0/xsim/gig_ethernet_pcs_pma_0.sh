...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L gig_ethernet_pcs_pma_v16_2_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gig_ethernet_pcs_pma_0 xil_defaultlib.gig_ethernet_pcs_pma_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/caleb/xilinx/Vivado/2023.2/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(gig_ethernet_pcs_pma_v16_2_1)
