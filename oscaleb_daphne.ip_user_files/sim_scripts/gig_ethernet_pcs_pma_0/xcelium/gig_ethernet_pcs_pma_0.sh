...
#
# Script generated by Vivado on Mon Mar 18 19:43:48 -03 2024
...
design_libs_elab="-libname xpm -libname gig_ethernet_pcs_pma_v16_2_1 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm gig_ethernet_pcs_pma_v16_2_1 xil_defaultlib)
...
compile()
{
  ...
  xmvhdl -work gig_ethernet_pcs_pma_v16_2_1 -V93 $xmvhdl_opts \
  "../../../ipstatic/hdl/gig_ethernet_pcs_pma_v16_2_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvlog -work gig_ethernet_pcs_pma_v16_2_1 $xmvlog_opts \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/caleb/caleb/fiuna/pasantia-tfg/mango-digitizer-daphne-v1/oscaleb_daphne/oscaleb_daphne.cache/compile_simlib/xcelium"
  fi
