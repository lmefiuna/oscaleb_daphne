...
design_libs=(xpm gig_ethernet_pcs_pma_v16_2_1 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work gig_ethernet_pcs_pma_v16_2_1 $vhdlan_opts \
  "../../../ipstatic/hdl/gig_ethernet_pcs_pma_v16_2_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vlogan -work gig_ethernet_pcs_pma_v16_2_1 $vlogan_opts +v2k \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/caleb/caleb/fiuna/pasantia-tfg/mango-digitizer-daphne-v1/oscaleb_daphne/oscaleb_daphne.cache/compile_simlib/vcs"
  fi
